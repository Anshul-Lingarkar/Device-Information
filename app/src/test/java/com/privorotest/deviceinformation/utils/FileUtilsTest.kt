...
class FileUtilsTest {
    ...
    fun testWriteDataToCsv() {
        ...
        val file =
            File(context.getExternalFilesDir(Environment.DIRECTORY_DOCUMENTS), "network_data.csv")
    ...
    fun testWriteDataToCsv_AppendToFile() {
        Mockito.`when`(context.getExternalFilesDir(Environment.DIRECTORY_DOCUMENTS))
            .thenReturn(externalFilesDir)
        val data = "192.168.1.1,12.34,56.78,01:01:2024 12:00:00,01:01:2024 17:00:00"
